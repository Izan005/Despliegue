...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.alumnosdb = await actions.mostrarAlumnosAction();
      _model.listaAlumnos = _model.alumnosdb!.toList().cast<dynamic>();
      safeSetState(() {});
    });
  }
                  ...
                  child: Stack(
                    children: [
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final lista = _model.listaAlumnos.toList();
                                ...
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    if (_model.choiceChipsValue == 'Alumnos') {
                                      ...
                                      context.pushNamed(
                                        EditarAsignaturaWidget.routeName,
                                        queryParameters: {
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  if (_model.choiceChipsValue == 'Alumnos') {
                                    context
                                        .pushNamed(CrearAlumnoWidget.routeName);
                                  } else {
                                    context.pushNamed(
                                        CrearAsignaturaWidget.routeName);
                                  }
                                },
                                child: Icon(
                                  Icons.add,
