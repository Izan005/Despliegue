...
class MatricularAlumnoWidget extends StatefulWidget {
  const MatricularAlumnoWidget({super.key});
...
class _MatricularAlumnoWidgetState extends State<MatricularAlumnoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.alumnos = await actions.mostrarAlumnosAction();
      _model.asignaturas = await actions.mostrarAsignaturasAction();
                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    _model.alumnoPorNombre =
                                        await actions.mostrarAlumnoPorIdAction(
                                      _model.dropDownValue1!,
                                    );
                                    _model.asignaturaPorNombre = await actions
                                        .mostrarAsignaturaPorNombreAction(
                                      _model.dropDownValue2!,
                                    );
                                    await actions.matricularAction(
                                      getJsonField(
                                        _model.alumnoPorNombre,
                                        r'''$.id''',
                                      ),
                                      getJsonField(
                                        _model.asignaturaPorNombre,
                                        r'''$.id''',
                                      ),
                                    );
